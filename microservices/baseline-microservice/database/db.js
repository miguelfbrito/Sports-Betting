...
// Doesn't work
if (drop_and_create) {
  console.log("Drop-Create database behaviour enabled")
  sequelize.query("drop database bettingwebapp;")
  sequelize.query("create database bettingwebapp;")
  sequelize.query("use bettingwebapp;")
}
